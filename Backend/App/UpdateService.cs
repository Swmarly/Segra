...
namespace Segra.Backend.App
{
    public static class UpdateService
    {
        ...
        public static GithubSource Source = new("https://github.com/Swmarly/Segra", null, false);
...
#pragma warning restore CS8625
        ...
        public static async Task GetReleaseNotes(bool forceCheck = false)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync($"https://api.github.com/repos/Swmarly/Segra/releases");
