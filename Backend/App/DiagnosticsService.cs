...
namespace Segra.Backend.App
{
    internal static class DiagnosticsService
    {
        ...
        private static void LogGameDetection()
        {
            ...
            Log.Information($"Game integrations: CS2={s.GameIntegrations.CounterStrike2.Enabled}, LoL={s.GameIntegrations.LeagueOfLegends.Enabled}, PUBG={s.GameIntegrations.Pubg.Enabled}, Apex={s.GameIntegrations.ApexLegends.Enabled}, RocketLeague={s.GameIntegrations.RocketLeague.Enabled}");
        }
